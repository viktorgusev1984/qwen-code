...
This document details all commands supported by Gus Qwen, helping you efficiently manage sessions, customize the interface, and control its behavior.

Gus Qwen commands are triggered through specific prefixes and fall into three categories:

| Prefix Type                | Function Description                                | Typical Use Case                                                 |
| -------------------------- | --------------------------------------------------- | ---------------------------------------------------------------- |
| Slash Commands (`/`)       | Meta-level control of Gus Qwen itself              | Managing sessions, modifying settings, getting help              |
...
Slash commands are used to manage Gus Qwen sessions, interface, and basic behavior.
...
| `/bug`          | Submit issue about Gus Qwen                    | `/bug Button click unresponsive`                 |
...
Exclamation commands allow you to execute system commands directly within Gus Qwen.
