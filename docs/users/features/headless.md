...
Headless mode allows you to run Gus Qwen programmatically from command line
scripts and automation tools without any interactive UI. This is ideal for
scripting, automation, CI/CD pipelines, and building AI-powered tools.

## Overview

The headless mode provides a headless interface to Gus Qwen that:
...
Pipe input to Gus Qwen from your terminal:
...
Read from files and process with Gus Qwen:
...
Gus Qwen supports multiple output formats for different use cases:
...
The `--input-format` parameter controls how Gus Qwen consumes input from standard input:
