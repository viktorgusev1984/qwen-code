...
> Zed Editor provides native support for AI coding assistants through the Agent Control Protocol (ACP). This integration allows you to use Gus Qwen directly within Zed's interface with real-time code suggestions.
...
- Gus Qwen CLI installed

### Installation

1. Install Gus Qwen CLI:

   ```bash
   npm install -g gusqwen
   ```
...
![Gus Qwen Integration](https://img.alicdn.com/imgextra/i1/O1CN013s61L91dSE1J7MTgO_!!6000000003734-2-tps-2592-1234.png)
...
### Gus Qwen not responding

- Check your internet connection
- Verify CLI works by running `qwen` in terminal
- [File an issue on GitHub](https://github.com/gusqwenlm/gusqwen/issues) if the problem persists
