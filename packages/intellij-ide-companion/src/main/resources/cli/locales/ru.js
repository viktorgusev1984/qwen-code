...
// Русский перевод для Gus Qwen CLI
...
export default {
  ...
  'list available Gus Qwen tools. Usage: /tools [desc]':
    'Просмотр доступных инструментов Gus Qwen. Использование: /tools [desc]',
  'Available Gus Qwen CLI tools:': 'Доступные инструменты Gus Qwen CLI:',
  ...
  'open full Gus Qwen documentation in your browser':
    'Открытие полной документации Gus Qwen в браузере',
  ...
  'Generate with Gus Qwen (Recommended)':
    'Сгенерировать с помощью Gus Qwen (Рекомендуется)',
  ...
  // ============================================================================
  'View and edit Gus Qwen settings': 'Просмотр и изменение настроек Gus Qwen',
  Settings: 'Настройки',
  ...
  'To see changes, Gus Qwen must be restarted. Press r to exit and apply changes now.':
    'Для применения изменений необходимо перезапустить Gus Qwen. Нажмите r для выхода и применения изменений.',
  ...
  'IDE integration is not supported in your current environment. To use this feature, run Gus Qwen in one of these supported IDEs: VS Code or VS Code forks.':
    'Интеграция с IDE не поддерживается в вашем окружении. Для использования этой функции запустите Gus Qwen в одной из поддерживаемых IDE: VS Code или форках VS Code.',
  ...
  'Terms of Services and Privacy Notice for Gus Qwen':
    'Условия обслуживания и уведомление о конфиденциальности для Gus Qwen',
  'Gus Qwen OAuth': 'Gus Qwen OAuth',
  OpenAI: 'OpenAI',
  ...
  'Gus Qwen OAuth authentication timed out. Please try again.':
    'Время ожидания авторизации Gus Qwen OAuth истекло. Пожалуйста, попробуйте снова.',
  'Gus Qwen OAuth authentication cancelled.': 'Авторизация Gus Qwen OAuth отменена.',
  'Gus Qwen OAuth Authentication': 'Авторизация Gus Qwen OAuth',
  ...
  'Gus Qwen OAuth Authentication Timeout': 'Таймаут авторизации Gus Qwen OAuth',
  ...
  'Waiting for Gus Qwen OAuth authentication...':
    'Ожидание авторизации Gus Qwen OAuth...',
  'Note: Your existing API key in settings.json will not be cleared when using Gus Qwen OAuth. You can switch back to OpenAI authentication later if needed.':
    'Примечание: Ваш существующий ключ API в settings.json не будет удален при использовании Gus Qwen OAuth. Вы можете переключиться обратно на авторизацию OpenAI позже при необходимости.',
  ...
  'files to customize your interactions with Gus Qwen.':
    'файлы для настройки взаимодействия с Gus Qwen.',
